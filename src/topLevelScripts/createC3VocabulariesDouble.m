...
save([outDir 'organicC3OldDoubleHNM.isolated.mat'],'organicFiles','method','options','models','-v7.3');
clear models;
...
save([outDir 'inorganicC3OldDoubleHNM.isolated.mat'],'inorganicFiles','method','options','models','-v7.3');
clear models;
...
% fprintf('c3...');
% save([outDir 'organicC3OldDoubleHNM.shared.mat'],'organicFiles','method','options','models','-v7.3');
% save([outDir 'inorganicC3OldDoubleHNM.shared.mat'],'inorganicFiles','method','options','models','-v7.3');
% clear;
% fprintf('saved...all\n')
